...
SECRET_KEY = 'django-insecure-7uz-^0m^&zu&aa7nc!9(x#p6nz(du%q4t_e5+aek&0)b!am%li'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1',
                 '9dgf4q6wx8.execute-api.us-west-2.amazonaws.com']
...
S3_BUCKET_NAME = "zappatestbucketjk"
